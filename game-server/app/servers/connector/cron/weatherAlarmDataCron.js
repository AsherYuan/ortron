                        ...
                        if (err) console.log(err);
                            ...
                            UserModel.find({}, function(err, docs) {
                                if (err) console.log(err);
									...
									var saving_notice_routing = function(userMobile, hasRead, title, content, noticeType, summary) {
                                    ...
                                    for (var i = 0; i < docs.length; i++) {
										...
										toRandering.push(saving_notice_routing(userMobile, hasRead, title, txt, noticeType, summary));
                                    }
